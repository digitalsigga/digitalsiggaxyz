...
function MaDesign() {
  const imageUrls = [
    ...
    "https://res.cloudinary.com/dvlggqgbf/image/upload/v1725700585/Editorial_6_hcavbw.jpg",
    "https://res.cloudinary.com/dvlggqgbf/image/upload/v1725700585/Editorial_3_oppjsl.jpg",
    "https://res.cloudinary.com/dvlggqgbf/image/upload/v1725700585/Editorial_2_o0yf6b.jpg",
